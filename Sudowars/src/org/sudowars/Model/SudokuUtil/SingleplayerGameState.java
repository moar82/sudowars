...
public class SingleplayerGameState extends GameState implements Serializable {
	 ...
	 */
	public SingleplayerGameState(SingleplayerGameStateParameter parameterObject) 
					throws IllegalArgumentException{
		
		super(parameterObject.game, parameterObject.difficulty);
		if (parameterObject.deltaManager == null)  throw new IllegalArgumentException("deltaManager cannot be null.");
		
		this.obviousMistakes = parameterObject.obviousMistakesShown;
		this.solveCell = parameterObject.solveCellAllowed;
		this.bookmark = parameterObject.bookmarkAllowed;
		this.backToFirstError = parameterObject.backToFirstError;
		this.correctSovedField = parameterObject.correctSolvedField;
		this.deltaManager = parameterObject.deltaManager;
	}
