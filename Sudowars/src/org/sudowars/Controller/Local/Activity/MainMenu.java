...
public class MainMenu extends PoolBinder {
	...
	public void setBtnSingleplayer(Button btnSingleplayer) {
	...
	protected void onResume() {
		...
		if (this.savedGames.hasSingleplayerGame() && this.layBtnSingleplayer.getChildCount() == 1) {
			...
			getBtnSingleplayer().setLayoutParams(new LinearLayout.LayoutParams(
					buttonWidth,
			...
			/*this.btnSingleplayer.setLayoutParams(new LinearLayout.LayoutParams(
					...
					LinearLayout.MarginLayoutParams.MATCH_PARENT));
			*/
			getBtnSingleplayer().setText(getString(R.string.button_singleplayer_symbol));
			...
			/*this.btnSingleplayer.setLayoutParams(new LinearLayout.LayoutParams(
					...
					LinearLayout.MarginLayoutParams.MATCH_PARENT));
			*/
			getBtnSingleplayer().setText(getString(R.string.button_singleplayer));
	...
	private void setupButtons() {
		...
		setBtnSingleplayer((Button) findViewById(R.id.btnSingleplayer));
		//this.btnSingleplayer = (Button) findViewById(R.id.btnSingleplayer);
		
		getBtnSingleplayer().setOnClickListener(
                new OnClickListener() {
